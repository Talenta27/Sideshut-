				...
				<div class="menu">
					<ul class="nav navbar-nav" role="tablist">
						<li><a href="index.php"><i class="fa fa-home">BERANDA</i></a></li>
							<li class="dropdown">
								<a href="#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false"><i class="fa fa-archive">PENDUDUK</i> <i class="fa fa-angle-down"></i></a>
								<ul class="dropdown-menu">
									<li><a href="penduduk.php">Hutatinggi</a></li>
								</ul>
							</li>
					</ul>
				</div>
